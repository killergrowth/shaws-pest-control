...
<meta property="og:image" content="https://${client.domain}/images/og-image.jpg">
...
<meta name="twitter:image" content="https://${client.domain}/images/og-image.jpg">
${schema || ''}
</head>
<body>
${HEADER}
