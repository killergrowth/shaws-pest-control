...
function buildHome() {
  ...
  const body = `
<section class="section-dark" style="padding:100px 0 80px;background:linear-gradient(145deg,rgba(26,42,36,0.82) 0%,rgba(42,92,69,0.72) 100%),url('/images/hero.png') center/cover no-repeat;display:flex;align-items:center;">
  <div class="container">
